...
** - ** Функцию (N, T) для генерации текстового файла из N строчек, на каждой строке записано случайное число от 1 до T - [`static void generate_file`](../src/ExternalSorter.cpp) <br>
	size_t n, uint32_t lim)
**ES1** Реализация алгоритма внешней сортировки ExternalSort первым способом [`static void external_sort_method1`](../src/ExternalSorter.cpp) <br>
**ES2** Реализация алгоритма внешней сортировки ExternalSort вторым способом, с двумя вспомогательными файлами [`static void external_sort_method2`](../src/ExternalSorter.cpp) <br>
**ES3** Реализовать алгоритм внешней сортировки ExternalSort третьим способом, при первом проходе в память загружать блоки по 100 чисел, сортировать их любым другим алгоритмом и отправлять на выход, а потом действовать по алгоритму ES2  - [`static void external_sort_method3`][`static void external_sort_method2`](../src/ExternalSorter.cpp) <br>
<br>
...
4. **Многопоточность**: Возможна параллельная внутренняя сортировка блоков в ES3
